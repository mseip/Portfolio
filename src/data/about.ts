export default {
    ...
    skills: {
        ui: [
            ...
            [
                "UML & Diagramming",
                "Experienced in creating UML diagrams, flowcharts, and system visuals to document workflows and user interactions.",
            ],
            [
                "Kdenlive",
                "Proficient in using Kdenlive to edit videos and create motion graphics for UX/UI design presentations and tutorials.",
            ],
        ],
